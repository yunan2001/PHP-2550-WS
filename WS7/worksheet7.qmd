...
hist(kidney_df$gfr, main = "", xlab = "gfr", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
hist(kidney_df$bascre, main = "", xlab = "bascre", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
hist(kidney_df$sbase, main = "", xlab = "sbase", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
hist(kidney_df$dbase, main = "", xlab = "dbase", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
hist(kidney_df$baseu, main = "", xlab = "baseu", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
hist(kidney_df$age, main = "", xlab = "age", col = "lightblue", 
     cex.main = 1, cex.lab = 1, cex.axis = 0.8, font.main = 1)
...
hist(kidney_df$log_bascre, main = "", xlab = "Log Transformed bascre", col = "lightblue", 
     cex.main = 0.8, cex.lab = 0.8, cex.axis = 0.5, font.main = 1)
hist(kidney_df$log_baseu, main = "", xlab = "Log Transformed baseu", col = "lightblue", 
     cex.main = 0.8, cex.lab = 0.8, cex.axis = 0.5, font.main = 1)
hist(kidney_df$sqrt_gfr, main = "", xlab = "Square Root gfr", col = "lightblue", 
     cex.main = 0.8, cex.lab = 0.8, cex.axis = 0.5, font.main = 1)
hist(kidney_df$log_gfr, main = "", xlab = "Log Transformed gfr", col = "lightblue", 
     cex.main = 0.8, cex.lab = 0.8, cex.axis = 0.5, font.main = 1)
...
autoplot(step_model, label.size = 3, size = 0.5) 
# +
#   ggtitle("Figure 5: Diagnostics Plots")
...
Table 5 shows the mean-square error between the measured and estimated values of GFR, the bias, and the percentage of the estimated values within 10% and 30% of the measured GFR. The MSE was much greater in black patients than in nonblack patients, suggesting that the model is notably less accurate in predicting GFR in black patients and that the model may not generalize well across racial groups. This might be due to an imbalance in the sample size of the data between the non-black and black groups, with black patients comprising only 10% of the data. The GFR values for non-blacks were slightly positively biased (0.12), while the model underestimated the GFR values for blacks with a negative bias of -8.55. For the percentages of the estimates, we can see that the predicted values are similar for both groups, with the predicted values for the non-black group being slightly better than the predicted values for the black group. This suggests that the model is able to predict GFR more precisely for nonblacks, but still captures the overall trend in GFR for both groups reasonably well.

Figure 6 shows the relationship between measured and estimated GFR by race, with the x-axis being the measured GFR and the y-axis being the estimated GFR. The black diagonal solid line represents a perfect fit, i.e., the estimated GFR is equal to the measured GFR. As we can see from the figure, the red line for non-black patients is closer to the line of perfect fit than the blue line for black patients. This difference suggests that the accuracy of the model's predictions may differ between these racial groups, and that the model appears to better predict non-black patients.
...
ggplot() +
  ...
  labs(title = "Figure 7: Density Plot of Square Root GFR by Race",
       x = "sqrt_gfr",
       y = "Density",
       fill = "Group") +
  theme_minimal()
...
tbl_combined2 <- tbl_merge(
  ...
  tab_spanner = c("**Original Scale**", "**Transformed Scale**", "**Race Removed**")
) 

tbl_combined2 <- tbl_combined2 %>%
  as_kable_extra(booktabs = TRUE, caption = "Summary Table by Race and Transformation",
                 longtable = TRUE, linesep = "") %>%

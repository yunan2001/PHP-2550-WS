...
&\quad + \beta_{12} \cdot \text{sex:}_1  \log(\text{bascre}) + \beta_{13} \cdot \text{black:}_1  \log(\text{bascre}) \\
&\quad + \beta_{14} \cdot \log(\text{bascre:})  \log(\text{baseu}) + \epsilon
\end{align*}
...
&\quad + \beta_8 \cdot \text{dbase:}  \log(\text{baseu}) + \beta_9 \cdot \text{age:}  \text{sex}_1 \\
&\quad + \beta_{10} \cdot \text{age:}  \log(\text{baseu}) + \beta_{11} \cdot \text{sex:}_1  \log(\text{bascre}) \\
&\quad + \beta_{12} \cdot \log(\text{bascre:}) \log(\text{baseu}) + \epsilon
\end{align*}

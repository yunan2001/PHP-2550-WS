...
```
Performing a short exploratory data analysis, 
```{r, out.width="80%"}
...
race_plot <- ggplot(kidney_df) +
  geom_boxplot(aes(x = black, y = gfr, fill = black)) +
  theme_minimal()

ggarrange(sex_plot, race_plot, main = "Figure 1: Boxplot of gfr by Sex and Race")
```
